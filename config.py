...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "1002226525317"))
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", join our second main channel for more fun 😌 https://t.me/+JG2goXnAxX44MGM1)
